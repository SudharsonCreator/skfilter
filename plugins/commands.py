    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝓢𝓚 𝓤𝓟𝓓𝓐𝓣𝓔𝓢 ⚔️', url=f"https://t.me/SKREQUEST") ] ] ),
            )
        return
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ 𝓢𝓚 𝓤𝓟𝓓𝓐𝓣𝓔𝓢 ⚔️', url="https://t.me/SKREQUEST") ] ] ),
            )
            filetype = msg.media
